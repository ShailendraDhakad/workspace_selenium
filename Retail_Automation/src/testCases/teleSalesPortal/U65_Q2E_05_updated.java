...
public class U65_Q2E_05_updated extends BaseExtentReport {
	...
	@BeforeMethod
	  ...
	  @Test
	  public void U65_Q2E_MyFamilyInfo_Invalid() throws Exception {
		  try{	
			 
			Map<String, String> TestDatadictionary = ExcelUtils.ReadExcelRowByIndexValue(Constant.TestData_File,"SIT","U65_Q2E_05_updated");
			...
			SFDCApplication.fillMyFamilyFormInvalidScenarios(TestDatadictionary);
