...
public class U65_Fulfillment_06 extends BaseExtentReport{
	...
	public void main() throws Exception {
		try {
			...
			//Validate Edit Button on Fulfillment detail page
			SFDCFullfillment.validateNoEditButtonFulfillmentDetailPage();
			...
			if (!SFDCFullfillment.fullfillment_Status().equalsIgnoreCase(Fulfillment_Status)){
				Reporter.log("Fulfillment Status is successfully changed to " + SFDCFullfillment.fullfillment_Status());
				Selenium.passTest("Fulfillment Status is successfully changed to " + SFDCFullfillment.fullfillment_Status());
			}
			else{
				Reporter.log("Fulfillment Status is Not changed to CMAPS Complted.");
				Selenium.failTest("Fulfillment Status is Not changed to CMAPS Complted.");
			}
