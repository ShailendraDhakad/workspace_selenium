...
public class U65_Q2E_06_updated extends BaseExtentReport{
	...
	@BeforeMethod
	  ...
	  @Test
	  public void U65_Q2E_ComparePlan_Invalid() throws Exception {
		  try{	
			 
			Map<String, String> TestDatadictionary = ExcelUtils.ReadExcelRowByIndexValue(Constant.TestData_File,"SIT","U65_Q2E_06_updated");
            ...
            SFDCApplication.fillComparePlanForm_InvalidConditions(TestDatadictionary);
		  }
			catch (Exception e){
